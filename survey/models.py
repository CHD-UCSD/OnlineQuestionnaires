...
class Question(models.Model):
    ...
    condition_question = models.ForeignKey('Question', blank=True, null=True)
    condition_answer = models.ForeignKey('Answer', null=True, blank=True, related_name="%(app_label)s_%(class)s_condition")
